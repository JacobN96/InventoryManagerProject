...
namespace InventoryManagerProject {
    ...
    public partial class itemsDataSet : global::System.Data.DataSet {
        ...
        public partial class itemsDataTable : global::System.Data.TypedTableBase<itemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public itemsRow AdditemsRow(int SKU, string Description, string Category, decimal Price, int Stock, int Reorder) {
        ...
        public partial class itemsRow : global::System.Data.DataRow {
            ...
            public int Reorder {
                get {
                    return ((int)(this[this.tableitems.ReorderColumn]));
                }
                set {
                    this[this.tableitems.ReorderColumn] = value;
                }
            }
        }
...
namespace InventoryManagerProject.itemsDataSetTableAdapters {
    ...
    public partial class itemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [items] WHERE (([SKU] = @Original_SKU) AND ([Description] = @Original" +
                "_Description) AND ([Category] = @Original_Category) AND ([Price] = @Original_Pri" +
                "ce) AND ([Reorder] = @Original_Reorder) AND ([Stock] = @Original_Stock))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [items] ([SKU], [Description], [Category], [Price], [Reorder], [Stock" +
                "]) VALUES (@SKU, @Description, @Category, @Price, @Reorder, @Stock);\r\nSELECT SKU" +
                ", Description, Category, Price, Reorder, Stock FROM items WHERE (SKU = @SKU)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [items] SET [SKU] = @SKU, [Description] = @Description, [Category] = @Category, [Price] = @Price, [Reorder] = @Reorder, [Stock] = @Stock WHERE (([SKU] = @Original_SKU) AND ([Description] = @Original_Description) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price) AND ([Reorder] = @Original_Reorder) AND ([Stock] = @Original_Stock));
SELECT SKU, Description, Category, Price, Reorder, Stock FROM items WHERE (SKU = @SKU)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InventoryManagerProject.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SKU, Description, Category, Price, Reorder, Stock FROM items";
        ...
        public virtual int Delete(int Original_SKU, string Original_Description, string Original_Category, double Original_Price, int Original_Reorder, int Original_Stock) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_Reorder));
        ...
        public virtual int Insert(int SKU, string Description, string Category, double Price, int Reorder, int Stock) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(Reorder));
        ...
        public virtual int Update(int SKU, string Description, string Category, double Price, int Reorder, int Stock, int Original_SKU, string Original_Description, string Original_Category, double Original_Price, int Original_Reorder, int Original_Stock) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Reorder));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_Reorder));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, string Category, double Price, int Reorder, int Stock, int Original_SKU, string Original_Description, string Original_Category, double Original_Price, int Original_Reorder, int Original_Stock) {
            return this.Update(Original_SKU, Description, Category, Price, Reorder, Stock, Original_SKU, Original_Description, Original_Category, Original_Price, Original_Reorder, Original_Stock);
        }
    }
